...
- **Portability**: Consumers supply their own dictionaries, locale routing, and themes. The showroom keeps its i18n, theme/font presets, and providers in `src/lib/`, its preview switchers in `src/showroom/`, and its Next.js proxy in `src/proxy.ts`.
